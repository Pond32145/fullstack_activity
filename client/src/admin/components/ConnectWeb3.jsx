  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col card h-100 p-3 bg-white rounded-lg shadow-lg pb-10">
